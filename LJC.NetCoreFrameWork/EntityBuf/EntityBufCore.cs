            ...
            switch (buftype.EntityType)
            {
                ...
                case EntityType.DICTIONARY:
                    ...
                    else
                    {
                        ...
                        System.Collections.IDictionary idic = (System.Collections.IDictionary)Activator.CreateInstance(buftype.ValueType);
                ...
                case EntityType.LIST:
                    ...
                    else
                    {
                        ...
                        if (listlen == -1)
                            return null;
                        var list = (System.Collections.IList)Activator.CreateInstance(buftype.ValueType);
