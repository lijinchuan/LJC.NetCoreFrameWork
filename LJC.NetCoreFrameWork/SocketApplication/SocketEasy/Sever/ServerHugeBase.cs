...
namespace LJC.NetCoreFrameWork.SocketApplication.SocketEasy.Sever
{
    public class ServerHugeBase : SocketBase
    {
        ...
        public bool StartServer()
        {
            try
            {
                ...
                if (_worktimer == null)
                {
                    _worktimer = TaskHelper.SetInterval(5000, () =>
                    {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (args.BufferRev == args.BufferLen)
                        {
                            ...
                            var calcrc32 = HashEncrypt.GetCRC32(args.Buffer, offset + 4, args.BufferLen - 4);
                            if (calcrc32 == crc32)
                            {
