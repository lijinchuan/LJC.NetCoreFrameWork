...
namespace LJC.NetCoreFrameWork.SocketApplication.SocketEasyUDP.Sever
{
    public class SessionServer : ServerBase
    {
        ...
        protected virtual void FromSessionMessage(Message message, UDPSession session)
        {
            ...
            {
                var sendfilemsg = EntityBufCore.DeSerialize<SendFileMessage>(message.MessageBuffer);
            ...
            {
                var request = EntityBufCore.DeSerialize<SendFileCheckRequestMessage>(message.MessageBuffer);
                var dir = AppDomain.CurrentDomain.BaseDirectory + "\\file\\";
