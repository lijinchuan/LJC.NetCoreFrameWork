...
{
    public class ESBServer : SocketApplication.SocketEasy.Sever.SessionServer
    {
        ...
        #region 管理web
        public class DefaultHander : Net.HTTP.Server.IRESTfulHandler
        {
            ...
            : base(port)
        {
            ...
            if (!string.IsNullOrWhiteSpace(ManagerWebPortStr))
            {
                ...
                manhttpserver.Handlers.Add(new Net.HTTP.Server.RESTfulApiHandlerBase(Net.HTTP.Server.HMethod.GET, "/esb/index", new List<string>() { }, new DefaultHander(this)));
            }
        }
